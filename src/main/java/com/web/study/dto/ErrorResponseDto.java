...
public class ErrorResponseDto extends ResponseDto {
	...
	public static <T> ErrorResponseDto of(HttpStatus status){
		return new ErrorResponseDto(status);
	}
	
	public static <T> ErrorResponseDto of(HttpStatus status, Exception e){
		return new ErrorResponseDto(status, e);
	}
	
	public static <T> ErrorResponseDto of(HttpStatus status, Exception e, Map<String,String> errorData){
		return new ErrorResponseDto(status, e, errorData);
	}
	
	
	public static <T> ErrorResponseDto empty () {
