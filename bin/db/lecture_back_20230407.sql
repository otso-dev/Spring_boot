...
--
-- Table structure for table `lecture_resgiste_mst`
--

DROP TABLE IF EXISTS `lecture_resgiste_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lecture_resgiste_mst` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `lecture_resgiste_mst`
--

LOCK TABLES `lecture_resgiste_mst` WRITE;
/*!40000 ALTER TABLE `lecture_resgiste_mst` DISABLE KEYS */;
/*!40000 ALTER TABLE `lecture_resgiste_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-04-07 17:46:25
